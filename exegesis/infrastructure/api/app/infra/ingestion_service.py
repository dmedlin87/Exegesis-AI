...
from exegesis.application.facades.events import get_event_publisher
...
from exegesis.application.facades.telemetry import log_workflow_event
from ..utils.imports import LazyImportModule

cli_ingest = LazyImportModule("exegesis.services.cli.ingest_folder")
...
def _load_cli_ingest_module() -> ModuleType:
    ...
    module = importlib.import_module("exegesis.services.cli.ingest_folder")
...
class IngestionService:
    ...
    def _publish_ingestion_event(
        ...
        *,
        ...
        event = DomainEvent(
            type="exegesis.ingestion.completed",
            payload=payload,
...
def get_ingestion_service(
    ...
    ingest_module = sys.modules.get("exegesis.infrastructure.api.app.routes.ingest")
