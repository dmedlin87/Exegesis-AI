...
def test_configure_deliverable_hooks_updates_module_exports() -> None:
    ...
    chat_module = importlib.reload(
        importlib.import_module("exegesis.infrastructure.api.app.research.ai.rag.chat")
    )
    ...
    importlib.reload(importlib.import_module("exegesis.infrastructure.api.app.research.ai.rag.workflow"))
