...
from exegesis.infrastructure.api.app.research.ai.trails import TrailService, TrailStepDigest
from exegesis.application.facades.database import Base
from exegesis.adapters.persistence.models import AgentTrail, ChatSession
from exegesis.infrastructure.api.app.models.ai import ChatGoalState, ChatMemoryEntry
...
def test_trail_digest_persists_chat_memory(
    ...
    monkeypatch.setattr(
        "exegesis.infrastructure.api.app.research.ai.trails_memory_bridge.celery",
        SimpleNamespace(
