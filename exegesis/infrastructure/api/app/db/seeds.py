...
from exegesis.adapters.persistence.sqlite import dispose_sqlite_engine
...
def _ensure_perspective_column(
    ...
    *,
    ...
    if "perspective" in missing:
        ...
        rebuilt = False
        if not table_exists or allow_repair:
            try:
                rebuilt, _ = _recreate_seed_table_if_missing_column(
                    session,
                    table,
    ...
    *,
    ...
    for attempt in range(max_attempts):
        ...
        try:
            ...
            if getattr(exc, "_EXEGESIS_missing_column_handled", False):
        ...
        try:
            for entry in payload:
                ...
                try:
                    ...
                    if not handled:
                        raise
                    setattr(exc, "_EXEGESIS_missing_column_handled", True)
                    raise
