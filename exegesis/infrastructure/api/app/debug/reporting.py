...
from exegesis.infrastructure.api.app.core.tracing import get_current_trace_id

SAFE_HEADER_PREFIXES = ("x-", "cf-", "forwarded")
SAFE_ENV_PREFIXES = ("EXEGESIS_", "APP_", "FEATURE_")
SENSITIVE_ENV_SUBSTRINGS = ("SECRET", "TOKEN", "KEY", "PASSWORD", "JWT")
LOGGER = logging.getLogger("exegesis.api.errors")
