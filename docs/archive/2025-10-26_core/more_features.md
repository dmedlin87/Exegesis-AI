...
# Exegesis AI: Deep-Research Bible Reader & Critical Analysis Agent
...
### 8.1 Goals
- Ingest YouTube (or any) transcripts that **you provide** into Exegesis AI's resource DB.
...
- **Provenance**: only ingest transcripts you own or have rights to use; or that you, the user, explicitly provide to Exegesis AI.
