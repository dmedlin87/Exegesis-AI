...
from exegesis.infrastructure.api.app.research.ai.rag.deliverables import generate_sermon_prep_outline
from exegesis.infrastructure.api.app.research.ai.rag.exports import (
...
from exegesis.infrastructure.api.app.research.ai.rag import GuardrailError, RAGCitation
from exegesis.infrastructure.api.app.export import citations as citation_exports
from exegesis.infrastructure.api.app.export.citations import build_citation_export
...
from exegesis.infrastructure.api.app.models.base import Passage as PassageSchema
from exegesis.infrastructure.api.app.models.documents import DocumentDetailResponse
from exegesis.infrastructure.api.app.models.export import serialise_asset_content
from exegesis.infrastructure.api.app.persistence_models import Document, Passage

from exegesis.infrastructure.api.app.core.errors import AIWorkflowError
...
# ``theo.infrastructure.api.app.export.citations`` but forgot to keep the re-export in
...
def _build_csl_entry(
    ...
    The heavy lifting lives in :mod:`theo.infrastructure.api.app.export.citations`.
