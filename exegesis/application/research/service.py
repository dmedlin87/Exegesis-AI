...
from exegesis.domain.repositories import HypothesisRepository, ResearchNoteRepository
from exegesis.domain.research.datasets import report_templates_dataset
