...
class Settings(BaseSettings):
    ...
    def __init__(self, **data: Any) -> None:
        ...
        if explicit_storage_root is not None:
            ...
            for env_key in ("EXEGESIS_STORAGE_ROOT", "STORAGE_ROOT"):
    ...
    storage_root: Path = Field(
        ...
        validation_alias=AliasChoices("EXEGESIS_STORAGE_ROOT", "STORAGE_ROOT"),
    ...
    reranker_model_registry_uri: str | None = Field(
        default=None,
        description="MLflow registry URI for the reranker checkpoint (e.g. models:/Exegesis AI/Production)",
    )
    ...
    user_agent: str = Field(default="Exegesis AI/1.0")
    ...
    settings_secret_backend: str | None = Field(
        ...
        validation_alias=AliasChoices(
            "EXEGESIS_SETTINGS_SECRET_BACKEND", "SETTINGS_SECRET_BACKEND"
        ),
    ...
    settings_secret_name: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "EXEGESIS_SETTINGS_SECRET_NAME", "SETTINGS_SECRET_NAME"
        ),
    ...
    settings_secret_field: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "EXEGESIS_SETTINGS_SECRET_FIELD", "SETTINGS_SECRET_FIELD"
        ),
    ...
    secrets_vault_addr: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "EXEGESIS_SECRETS_VAULT_ADDR", "SECRETS_VAULT_ADDR"
        ),
    ...
    secrets_vault_token: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "EXEGESIS_SECRETS_VAULT_TOKEN", "SECRETS_VAULT_TOKEN"
        ),
    ...
    secrets_vault_namespace: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "EXEGESIS_SECRETS_VAULT_NAMESPACE", "SECRETS_VAULT_NAMESPACE"
        ),
    ...
    secrets_vault_mount_point: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "EXEGESIS_SECRETS_VAULT_MOUNT_POINT", "SECRETS_VAULT_MOUNT_POINT"
        ),
    ...
    secrets_vault_verify: bool | str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "EXEGESIS_SECRETS_VAULT_VERIFY", "SECRETS_VAULT_VERIFY"
        ),
    ...
    secrets_aws_profile: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "EXEGESIS_SECRETS_AWS_PROFILE", "SECRETS_AWS_PROFILE"
        ),
    ...
    auth_allow_anonymous: bool = Field(
        default=False,
        validation_alias=AliasChoices(
            "EXEGESIS_AUTH_ALLOW_ANONYMOUS", "AUTH_ALLOW_ANONYMOUS"
        ),
...
def get_settings_cipher() -> Fernet | None:
    ...
    if allow_insecure_startup():
        fallback = "Exegesis AI-insecure-test-secret"
        LOGGER.warning(
