...
``from exegesis.infrastructure.api.app.research.ai.ledger import CacheRecord`` continues to work
...
_LEGACY_SPEC = importlib.util.spec_from_file_location(
    "exegesis.infrastructure.api.app.research.ai._legacy_ledger",
    _LEGACY_PATH,
)
