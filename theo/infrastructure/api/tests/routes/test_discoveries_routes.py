...
from theo.infrastructure.api.app.infra.ingestion_service import get_ingestion_service
...
def schedule_refresh_mock(monkeypatch: pytest.MonkeyPatch) -> MagicMock:
    ...
    monkeypatch.setattr(
        "theo.infrastructure.api.app.routes.ingest.schedule_discovery_refresh",
