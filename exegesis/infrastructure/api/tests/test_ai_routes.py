...
from exegesis.adapters.persistence.models import AgentTrail, ChatSession, Document, Passage
...
from exegesis.services.cli.batch_intel import main as batch_intel_main
