...
from exegesis.application.core.telemetry import EMBEDDING_REBUILD_PROGRESS_METRIC
from exegesis.application.retrieval.embeddings.checkpoint_store import (
    CheckpointError,
    EmbeddingCheckpoint,
    load_checkpoint,
    save_checkpoint,
...
def _ensure_cli_telemetry() -> None:
    ...
    try:
        ...
        try:
            from exegesis.infrastructure.api.app.adapters.telemetry import (
