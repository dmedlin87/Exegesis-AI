...
from exegesis.adapters.persistence.models import TranscriptSegment
...
def test_refresh_creator_rollups_helper_handles_async_failure(
    ...
    try:
        from exegesis.infrastructure.api.app.workers import tasks as worker_tasks
        from exegesis.infrastructure.api.app.library.ingest.pipeline import _refresh_creator_verse_rollups
        ...
        monkeypatch.setattr(
            "exegesis.infrastructure.api.app.creators.verse_perspectives.CreatorVersePerspectiveService.refresh_many",
            fake_refresh_many,
        )
