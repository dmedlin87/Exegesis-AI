...
|---|---------|----------|--------|--------------|
| 1 | Parallel Translation Viewer | Must-Have | ~10 days | Canon service, verse repository |
| 2 | Original Language Toolkit | Must-Have | ~15 days | Hebrew WLC data, lexicon data |
| 3 | Cross-Reference Graph | Must-Have | ~15 days | D3.js, cross-ref seed data |
| 4 | AI Study Outline Generator | High | ~15 days | RAG pipeline, LLM integration |
| 5 | Collaborative Annotations | High | ~17 days | User auth, WebSocket |
