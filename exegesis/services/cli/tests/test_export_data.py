...
from exegesis.infrastructure.api.app.models.export import ExportManifest
...
def export_module(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> ModuleType:
    ...
    module_name = "exegesis.services.cli.export_data"

    registry = _StubRegistry()
    monkeypatch.setattr(
        "exegesis.application.services.bootstrap.resolve_application",
    ...
    install_stub(
        "exegesis.infrastructure.api.app.export.citations",
        {
    ...
    install_stub(
        "exegesis.infrastructure.api.app.export.formatters",
        {
    ...
    install_stub(
        "exegesis.infrastructure.api.app.models.search",
        {
    ...
    install_stub(
        "exegesis.infrastructure.api.app.retrieval.retriever.export",
        {
    ...
    install_stub(
        "exegesis.infrastructure.api.app.retrieval.retriever.verses",
        {"get_mentions_for_osis": lambda *a, **k: []},
    )
    install_stub(
        "exegesis.infrastructure.api.app.models.verses",
        {
