...
from exegesis.application.facades.database import configure_engine, get_engine, get_session
...
def test_export_to_zotero_success(client: TestClient):
    ...
    with patch("exegesis.infrastructure.api.app.routes.export.export_to_zotero") as mock_export:
...
def test_export_to_zotero_api_error(client: TestClient):
    ...
    from exegesis.infrastructure.api.app.export.zotero import ZoteroExportError
...
def test_export_to_zotero_request_validation():
    ...
    from exegesis.infrastructure.api.app.models.export import ZoteroExportRequest
...
def test_export_to_zotero_response_model():
    ...
    from exegesis.infrastructure.api.app.models.export import ZoteroExportResponse
