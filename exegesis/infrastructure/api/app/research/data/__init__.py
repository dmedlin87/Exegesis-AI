...
Migration guidance:
    Old imports: exegesis.infrastructure.api.app.research.data.*
    New imports: exegesis.data.research.*
...
from exegesis.data import research as _research
...
# Ensure ``importlib.resources.files("exegesis.infrastructure.api.app.research.data")``
