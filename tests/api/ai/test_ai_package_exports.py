...
def reload_ai_module():
    ...
    ai_module = importlib.import_module("exegesis.infrastructure.api.app.research.ai")
...
def test_ai_package_exposes_legacy_submodules(module_name: str) -> None:
    ...
    assert exported.__name__.startswith("exegesis.infrastructure.api.app.research.ai."), (
