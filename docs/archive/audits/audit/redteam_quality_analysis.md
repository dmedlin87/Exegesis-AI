...
- Pytest reports only pre-existing third-party warnings (Pydantic alias metadata and SQLAlchemy drop-order hints); no Exegesis AI code regressions were detected.【50e7f6†L1-L24】
