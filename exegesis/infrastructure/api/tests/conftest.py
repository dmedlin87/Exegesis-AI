...
_DISCOVERIES_MODULE = types.ModuleType("exegesis.infrastructure.api.app.research.discoveries")
_DISCOVERY_TASKS_MODULE = types.ModuleType("exegesis.infrastructure.api.app.research.discoveries.tasks")
...
sys.modules.setdefault("exegesis.infrastructure.api.app.research.discoveries", _DISCOVERIES_MODULE)
sys.modules.setdefault("exegesis.infrastructure.api.app.research.discoveries.tasks", _DISCOVERY_TASKS_MODULE)
...
def _use_pgvector_backend(request: pytest.FixtureRequest) -> bool:
    try:
        option = request.config.getoption("pgvector")
