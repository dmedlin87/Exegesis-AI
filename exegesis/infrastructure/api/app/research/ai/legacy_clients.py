...
from exegesis.application.interfaces import LanguageModelClientProtocol
...
class AIClientSettings:
    ...
    user_agent: str = "Exegesis AI-AIClient/1.0"
    log_metadata: dict[str, Any] = field(default_factory=lambda: {"component": "ai-client"})
    logger: logging.Logger = field(
        default_factory=lambda: logging.getLogger("exegesis.infrastructure.api.ai.clients")
    )
