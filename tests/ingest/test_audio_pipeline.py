...
from exegesis.infrastructure.api.app.library.ingest.pipeline import run_pipeline_for_audio
from exegesis.infrastructure.api.app.library.ingest.stages.fetchers import AudioSourceFetcher
from exegesis.infrastructure.api.app.library.ingest.stages.parsers import AudioTranscriptionParser
from exegesis.infrastructure.api.app.library.ingest.stages.persisters import AudioDocumentPersister
...
@patch("exegesis.infrastructure.api.app.library.ingest.stages.parsers.WhisperModel", autospec=True)
...
@patch("exegesis.infrastructure.api.app.library.ingest.stages.parsers.VerseDetector", autospec=True)
