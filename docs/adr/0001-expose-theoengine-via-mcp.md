# ADR 0001: Expose Exegesis AI via the Model Context Protocol

## Status
Accepted

## Context
Exegesis AI powers a variety of research workflows that benefit from structured tool
...
## Decision
We will expose Exegesis AI functionality through an MCP server. The initial
