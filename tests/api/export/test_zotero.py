...
from exegesis.infrastructure.api.app.export.zotero import (
    ZoteroExportError,
    export_to_zotero,
...
from exegesis.infrastructure.api.app.export.citations import CitationSource
...
async def test_export_to_zotero_success(sample_source, sample_csl_entry):
    ...
    with patch("exegesis.infrastructure.api.app.export.zotero.httpx.AsyncClient") as mock_client:
