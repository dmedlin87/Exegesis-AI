...
from exegesis.application.facades.database import get_session as get_db_session
...
def export_search(
    ...
    export_package = import_module("exegesis.infrastructure.api.app.routes.export")
