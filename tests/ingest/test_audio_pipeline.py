...
from theo.infrastructure.api.app.library.ingest.pipeline import run_pipeline_for_audio
from theo.infrastructure.api.app.library.ingest.stages.fetchers import AudioSourceFetcher
from theo.infrastructure.api.app.library.ingest.stages.parsers import AudioTranscriptionParser
from theo.infrastructure.api.app.library.ingest.stages.persisters import AudioDocumentPersister
...
@patch("theo.infrastructure.api.app.library.ingest.stages.parsers.WhisperModel", autospec=True)
...
@patch("theo.infrastructure.api.app.library.ingest.stages.parsers.VerseDetector", autospec=True)
