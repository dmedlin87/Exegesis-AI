...
from exegesis.infrastructure.api.app.library.ingest import parsers as ingest_parsers  # noqa: E402
from exegesis.infrastructure.api.app.library.ingest.pipeline import _parse_text_file  # noqa: E402
...
def test_ingest_file_pipeline_exposes_private_parse_text_helper(
    ...
    from exegesis.infrastructure.api.app.library.ingest import pipeline as ingest_pipeline
