...
from exegesis.infrastructure.api.app.research.ai import AIProvider
from exegesis.infrastructure.api.app.research.ai.clients.local_client import LocalAIClient


@pytest.fixture
def mock_openai():
    with patch("exegesis.infrastructure.api.app.research.ai.clients.local_client.openai") as mock:
        yield mock
