...
RAG_CACHE_EVENTS_METRIC = "EXEGESIS_rag_cache_events_total"
CITATION_DRIFT_EVENTS_METRIC = "EXEGESIS_citation_drift_events_total"
SEARCH_RERANKER_EVENTS_METRIC = "EXEGESIS_search_reranker_events_total"

# Embedding rebuild workflow ----------------------------------------------------
EMBEDDING_REBUILD_BATCH_LATENCY_METRIC = (
    "EXEGESIS_embedding_rebuild_batch_latency_seconds"
)
EMBEDDING_REBUILD_COMMIT_LATENCY_METRIC = (
    "EXEGESIS_embedding_rebuild_commit_latency_seconds"
)
EMBEDDING_REBUILD_PROGRESS_METRIC = "EXEGESIS_embedding_rebuild_processed_total"

# Database query monitoring ------------------------------------------------------
DB_QUERY_LATENCY_METRIC = "EXEGESIS_db_query_latency_seconds"
DB_QUERY_REQUESTS_METRIC = "EXEGESIS_db_query_requests_total"
DB_QUERY_ERROR_METRIC = "EXEGESIS_db_query_errors_total"

# ML inference telemetry --------------------------------------------------------
LLM_INFERENCE_LATENCY_METRIC = "EXEGESIS_llm_inference_latency_seconds"
LLM_INFERENCE_REQUESTS_METRIC = "EXEGESIS_llm_inference_requests_total"
LLM_INFERENCE_ERROR_METRIC = "EXEGESIS_llm_inference_errors_total"
