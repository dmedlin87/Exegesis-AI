...
_ATTRIBUTE_EXPORTS = {
    "CommandService": ("exegesis.application.interfaces", "CommandService"),
    "QueryService": ("exegesis.application.interfaces", "QueryService"),
    "ApplicationContainer": (
        "exegesis.application.services",
        "ApplicationContainer",
    ),
    "ReportSection": ("exegesis.application.research", "ReportSection"),
    "ResearchReport": ("exegesis.application.research", "ResearchReport"),
    "ResearchService": ("exegesis.application.research", "ResearchService"),
}
...
def __getattr__(name: str) -> Any:
    ...
    ``from exegesis.application import <symbol>``.
    """
