...
try:  # pragma: no cover - optional telemetry dependency
    ...
    from exegesis.infrastructure.api.app.research.ai.router import _NoopTracer
...
from exegesis.application.facades.telemetry import set_span_attribute

_LOGGER = logging.getLogger(__name__)
_TRACER = trace.get_tracer("exegesis.embedding")
...
def _flag_model_enabled() -> bool:
    ...
    if _RuntimeFlagModel is None:
        return False
    if os.environ.get("EXEGESIS_FORCE_EMBEDDING_FALLBACK"):
        return False
