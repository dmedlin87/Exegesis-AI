...
from exegesis.adapters.persistence.models import Document, DocumentAnnotation, Passage
...
from exegesis.infrastructure.api.app.retrieval.retriever.hybrid import (
    _Candidate,
    _fallback_search,
