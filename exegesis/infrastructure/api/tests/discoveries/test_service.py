...
sys.modules.pop("exegesis.infrastructure.api.app.research.discoveries", None)
sys.modules.pop("exegesis.infrastructure.api.app.research.discoveries.service", None)
sys.modules.pop("exegesis.infrastructure.api.app.research.discoveries.tasks", None)

from exegesis.adapters.persistence.discovery_repository import (  # noqa: E402 - imported after cleanup
    SQLAlchemyDiscoveryRepository,
)
from exegesis.adapters.persistence.document_repository import (  # noqa: E402 - imported after cleanup
...
from exegesis.domain.discoveries import CorpusSnapshotSummary, DiscoveryType
from exegesis.infrastructure.api.app.research.discoveries.service import DiscoveryService  # noqa: E402
