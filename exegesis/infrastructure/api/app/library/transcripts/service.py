...
from exegesis.application.repositories.transcript_repository import TranscriptRepository
from exegesis.domain.research.osis import expand_osis_reference, format_osis
