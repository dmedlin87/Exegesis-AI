...
chunking_module = importlib.import_module("exegesis.infrastructure.api.app.library.ingest.chunking")
...
from exegesis.services.api.app.ingest import chunking as legacy_chunking  # noqa: E402
