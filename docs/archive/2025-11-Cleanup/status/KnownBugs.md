...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BUG-2025-10-001 | Reranker hash verification crashes without hashlib import | Critical | Resolved | AI Agent | 2025-10-20 | 2025-10-20 | `theo/infrastructure/api/app/retrieval/ranking/re_ranker.py` | this PR |
| BUG-2025-10-002 | Loading a reranker from a directory fails to locate the artifact | Major | Resolved | AI Agent | 2025-10-20 | 2025-10-20 | `theo/infrastructure/api/app/retrieval/ranking/re_ranker.py` | this PR |
