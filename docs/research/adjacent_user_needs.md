...
> **Purpose:** Identify high-value adjacent problems for Exegesis AI users that extend beyond the platform's current verse-anchored research workflows.

## Context

Exegesis AI excels at deterministic retrieval, OSIS-normalized verse aggregation, and evidence-backed summarization. Pastors, academic researchers, and research assistants rely on the platform to keep theological analysis traceable and well-cited. As adoption grows, teams are asking Exegesis AI to support the broader lifecycle of sermon preparation, comparative scholarship, and ministry coordination. This brief highlights unmet needs that repeatedly surface in interviews, support threads, and roadmap planning sessions but are not yet core product features.
...
1. **"Our sermon team uses Exegesis AI to verify citations, but the outline lives in Notion."**<br>
...
2. **"The Latin translations live outside Exegesis AI, so our patristics class can't use the same workflow."**<br>
...
4. **"Our small group leaders need simplified discussion prompts."**<br>
   *Signal:* Volunteers default to third-party devotionals because Exegesis AI outputs assume deep exegetical training.<br>
...
|  | Persona-aware prompt marketplace | Differentiates Exegesis AI's agent workflows while staying verse anchored. | Build prompt governance framework and curation workflow. |
...
Keeping these adjacencies visible helps ensure Exegesis AI grows beyond its excellent retrieval core and supports the broader rhythm of theological research teams.
