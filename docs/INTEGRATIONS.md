...
* **Authentication:** Configure API keys or JWT credentials via the `EXEGESIS_API_KEYS`/`EXEGESIS_AUTH_*` environment variables before issuing requests. See [`SECURITY.md`](../SECURITY.md) for guidance.
